...
export default function SignUpModal() {
  ...
  return (
    <>
      ...
      >
        <div
          className="w-full h-full sm:w-[600px] sm:h-fit bg-white sm:rounded-xl
        outline-none"
        >
          <XMarkIcon
          ...
          <div className="pt-10 pb-20 px-4 sm:px-20">
            ...
            <div className="w-full space-y-5 mb-10">
              <input
                className="w-full h-[54px] border border-gray-200 outline-none pl-3 
                rounded-[4px] focus:border-[#F4AF01] transition"
                placeholder="Name"
                type="text"
              ...
              <div
                ...
                rounded-[4px] focus-within:border-[#F4AF01] transition flex items-center overflow-hidden
                pr-3"
              >
                <input
            ...
            <button
              className="bg-[#f4AF01] text-white h-[48px] rounded-full
