    ...
    <>
      ...
      >
        ...
        <div className="flex-grow  max-w-2xl border-x border-gray-100 ">
          <div
            className="py-4 px-3 text-lg sm:text-xl sticky top-0 z-50 bg-white
                   bg-opacity-80 backdrop-blur-sm border-b border-gray-100 flex items-center"
          >
            <Link href="/">
          ...
          <div className="flex flex-col p-3 space-y-5 border-b border-grey-100">
            <div
           ...
           overflow-hidden text-ellipsis max-w-[60px] 
